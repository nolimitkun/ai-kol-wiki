# Biggest Mysteries in Physics: Antimatter, Dark Energy & ToE - Don Lincoln（Lex Fridman #497，2026-05-29）

- **嘉宾**: Don Lincoln（Fermilab 粒子物理学家、科普作者）
- **主持**: [Lex Fridman](../people/lex-fridman.md)
- **来源**: [YouTube](https://www.youtube.com/watch?v=1M3Vdl6DRkU) · 174 分钟
...
牛顿统一天上与地上的引力（"universal" 一词的分量）→ Maxwell 统一电与磁 →
电弱统一 → 标准模型，以及尚未解决的大谜团：反物质不对称、暗物质/暗能量、
量子力学与广义相对论的不相容（Theory of Everything 之路）。

Lex 评价其有"费曼式"的化繁为简能力。与 [Adam Brown 的 GR 讲座](20260710-dwarkesh-adam-brown-general-relativity.md)同属科普性物理内容，可互为参照。
