...
- Andy Jones《Scaling Scaling Laws with Board Games》(2021) 证明：**可用更多搜索（MCTS sims）换取更少训练算力**，等效性能——提前预示了后来 LLM 的 inference scaling；还能预测"解更大棋盘需要多少算力"（[01:51:03]–[01:52:08]）。可与 [评估与 Benchmark](../topics/evaluation-and-benchmarks.md)、[LLM 训练管线](../topics/llm-training-pipeline.md) 的 test-time compute 讨论对照。
