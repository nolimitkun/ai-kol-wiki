...
- **路径依赖跨越 chasm**：超算/国家实验室→油气/制药→主权基金 G42 的 10 亿美元订单（重构供应链、大集群 battle test）→OpenAI 200 亿美元大单 **24 天签成** + AWS 部署；今年制造 10x（00:09:05–00:24:11）。
- **AI 编码"从 10x 到 100x 但非人人适用"**：少数有"完美心智"的人同时跑 8–10 个 agent、把编码转成"治理 agent"；token 花费从 <$1K/人月 到 $25–30K（00:12:05–00:13:05）。
- **快 AI 催生新商业模式（Netflix 类比）**：速度不是让现有模式变好一点——Netflix 从寄 DVD 变电影公司；AI 现在只替代看得见的（编码/设计/SaaS），围绕它**重组工作方式**后才有新商业模式与生产力跃迁（00:28:14–00:29:14）。
...
- **开源与主权**：开源今年闭合了 gap（"不会开法拉利去买菜"）；Cerebras 跑 GLM/Kimi/Qwen + 闭源；美国需要更多**本土开源模型**（现只有 OSS 12B 或中国模型）；OpenAI/Amazon 自研芯片是"没人喜欢依赖"（00:14:07–00:20:12）。
- **分阶段发布不 unreasonable**：类比强效药/FDA、给 NSA 两三周补洞；极化伤害清晰思考；行业该更好地自我监管；PANW 用新模型对自家软件"发现从不知道的 bug、停工打补丁 6 周"（00:20:12–00:26:21）。
- **"AGI 已命中、只是没完全部署" + 递归/loop maxing + 丰饶叙事**：递归增益是指数的；范式不会死是持范式的人死了（凡尔赛宫/跨代石匠类比）；有机会让"我们的孩子无人死于癌症"（00:29:22–00:40:28）。
