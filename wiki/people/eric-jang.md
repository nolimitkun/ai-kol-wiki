...
## 相关：1X 的创始人侧视角（2026-07）

[Bernt Børnich（1X 创始人兼 CEO）](bernt-bornich.md) 于 2026-07-29 进入本库，提供**产品/数据战略**侧的 1X 视角，与本页的**研究/RL**侧互补。
⚠️ 值得对读的一点：Jang 关心的是 self-play 与长程 RL 的**样本效率**；Børnich 的路线是**绕开样本效率问题、直接换一个大得多的数据源**（互联网人类视频，"**我们的跨本体是人**"）。两者是同一瓶颈的两种解法。
